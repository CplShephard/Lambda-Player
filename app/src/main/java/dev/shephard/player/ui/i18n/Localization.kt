...
data class Strings(
    ...
    val themeUiStyleSection: String = "UI Style",
    val themeMiuixUiSection: String = "Miuix UI",
    val themeM3UiSection: String = "Material 3 UI",
    val wallpaper: String,
    val chooseFromGallery: String,
    val changeWallpaper: String,
    val removeWallpaper: String,
    val removeWallpaperConfirm: String = "Are you sure you want to remove the wallpaper?",
    val removeCoverConfirm: String = "Are you sure you want to remove the cover photo?",
    val removePlaylistConfirm: String = "Are you sure you want to delete this playlist?",
    val language: String,
    ...
    val accessYourMusic: String = "Access your music",
    val permissionDescription: String = "Lambda Player needs permission to read audio files stored on this device.",
    val grantAccess: String = "Grant access",
    val emptyLibraryHint: String = "Add audio files to your device storage to see them here.",
    val reorder: String = "Reorder",
    val menu: String = "Menu",
    val playbackPosition: String = "Playback position",
    ...
    val googleUi: String = "Material 3",
    ...
    val appleFloatingBar: String = "Floating Bar",
    val appleFloatingBarDescription: String = "Use the floating pill dock instead of the navigation bar.",
    val m3FloatingBar: String = "Material 3 Floating Bar",
    val m3FloatingBarDescription: String = "Off: classic Material 3 navigation bar. On: Material 3 floating bar.",
    val dynamicColorDescription: String = "Use the system wallpaper colors (Android 12+).",
    val predictiveBackTitle: String = "Predictive Back",
    val predictiveBackDescription: String = "Choose the back gesture animation.",
    val predictiveBackNone: String = "None",
    val predictiveBackAosp: String = "AOSP",
    val predictiveBackMiuix: String = "MIUIX",
    val predictiveBackScale: String = "Scale",
    val predictiveBackClassic: String = "Classic",
    val predictiveBackExitDirectionTitle: String = "Exit Direction",
    val predictiveBackExitDirectionDescription: String = "Where the popped page travels.",
    val predictiveBackFollowGesture: String = "Follow Gesture",
    val predictiveBackAlwaysRight: String = "Always Right",
    val predictiveBackAlwaysLeft: String = "Always Left",
...
private val EN = Strings(
    ...
    noSongsToPlay = "No songs to play",
...
private val TR = EN.copy(
    ...
    themeUiStyleSection = "Arayüz Stili", themeMiuixUiSection = "Miuix Arayüzü", themeM3UiSection = "Material 3 Arayüzü",
    ...
    noSongsToPlay = "Çalınacak şarkı yok",
    ...
    predictiveBackTitle = "Tahmini Geri",
    predictiveBackDescription = "Geri hareket animasyonunu seç.",
    predictiveBackExitDirectionTitle = "Çıkış Yönü",
    predictiveBackExitDirectionDescription = "Geri giden sayfanın yönü.",
    ...
    accessYourMusic = "Müziklerine eriş", permissionDescription = "Lambda Player'ın bu cihazda depolanan ses dosyalarını okumak için izne ihtiyacı var.", grantAccess = "İzin ver", emptyLibraryHint = "Ses dosyalarını cihaz depolamasına eklediğinde burada görünecek.", reorder = "Yeniden sırala", menu = "Menü", playbackPosition = "Çalma konumu",
    appName = "Lambda Player",
    uiEngine = "Arayüz Motoru",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "Uygulamanın kullanacağı tasarım dilini seç.",
    miuixCustomColors = "Miuix Özel Renkleri",
    miuixCustomColorsDescription = "Tüm Miuix paletini tohum renkten üret (Monet motoru).",
    paletteStyle = "Palet Stili",
    paletteStyleDescription = "Tohum rengi için renk üretim stili.",
    colorSpec = "Renk Belirtimi",
    colorSpecDescription = "Renk şeması belirtim sürümü.",
    colorSpecOnly2021 = "Mevcut palet stili yalnızca Spec 2021'i destekliyor",
    appleFloatingBar = "Yüzen Bar",
    appleFloatingBarDescription = "Navigasyon çubuğu yerine yüzen hap dock kullan.",
    m3FloatingBar = "Material 3 Yüzen Bar",
    m3FloatingBarDescription = "Kapalı: klasik Material 3 navigasyon çubuğu. Açık: Material 3 yüzen bar.",
    dynamicColorDescription = "Sistem duvar kağıdı renklerini kullan (Android 12+).",
    removeWallpaperConfirm = "Duvar kağıdını kaldırmak istediğine emin misin?",
    removeCoverConfirm = "Kapak fotoğrafını kaldırmak istediğine emin misin?",
    removePlaylistConfirm = "Bu çalma listesini silmek istediğine emin misin?",
    predictiveBackNone = "Yok",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "Ölçek",
    predictiveBackClassic = "Klasik",
    predictiveBackFollowGesture = "Jest İzle",
    predictiveBackAlwaysRight = "Her Zaman Sağ",
    predictiveBackAlwaysLeft = "Her Zaman Sol",
    close = "Kapat",
    appearance = "Görünüm",
)
...
private val ZH = EN.copy(
    ...
    themeUiStyleSection = "界面样式", themeMiuixUiSection = "Miuix 界面", themeM3UiSection = "Material 3 界面",
    ...
    removeCover = "移除封面",
    blurEffect = "模糊效果",
    predictiveBackTitle = "预测返回",
    predictiveBackDescription = "选择返回手势动画。",
    predictiveBackExitDirectionTitle = "退出方向",
    predictiveBackExitDirectionDescription = "被退出页面的移动方向。",
    ...
    accessYourMusic = "访问你的音乐", permissionDescription = "Lambda Player 需要权限才能读取此设备上存储的音频文件。", grantAccess = "授予权限", emptyLibraryHint = "将音频文件添加到设备存储中，即可在此处查看。", reorder = "重新排序", menu = "菜单", playbackPosition = "播放位置",
    appName = "Lambda Player",
    uiEngine = "界面引擎",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "选择应用使用的设计语言。",
    miuixCustomColors = "Miuix 自定义颜色",
    miuixCustomColorsDescription = "从种子颜色生成整个 Miuix 调色板（Monet 引擎）。",
    paletteStyle = "调色板样式",
    paletteStyleDescription = "种子颜色的颜色生成样式。",
    colorSpec = "颜色规范",
    colorSpecDescription = "配色方案规范版本。",
    colorSpecOnly2021 = "当前调色板样式仅支持 Spec 2021",
    appleFloatingBar = "悬浮栏",
    appleFloatingBarDescription = "使用悬浮胶囊式 Dock 而非导航栏。",
    m3FloatingBar = "Material 3 悬浮栏",
    m3FloatingBarDescription = "关：经典 Material 3 导航栏。开：Material 3 悬浮栏。",
    dynamicColorDescription = "使用系统壁纸颜色（Android 12 及以上）。",
    removeWallpaperConfirm = "确定要移除壁纸吗？",
    removeCoverConfirm = "确定要移除封面图片吗？",
    removePlaylistConfirm = "确定要删除此播放列表吗？",
    predictiveBackNone = "无",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "缩放",
    predictiveBackClassic = "经典",
    predictiveBackFollowGesture = "跟随手势",
    predictiveBackAlwaysRight = "始终向右",
    predictiveBackAlwaysLeft = "始终向左",
    close = "关闭",
    appearance = "外观",
)
...
private val ES = EN.copy(
    ...
    crossfade = "Fundido entre canciones", gapless = "Reproducción sin pausas",
    playWithOthers = "Reproducir junto con otras apps",
    themeSettings = "Tema", accentColor = "Color de acento",
    themeUiStyleSection = "Estilo de interfaz", themeMiuixUiSection = "Interfaz Miuix", themeM3UiSection = "Interfaz de Material 3",
    ...
    noSongsToPlay = "No hay canciones para reproducir",
    ...
    predictiveBackTitle = "Retroceso predictivo",
    predictiveBackDescription = "Elige la animación del gesto de retroceso.",
    predictiveBackExitDirectionTitle = "Dirección de salida",
    predictiveBackExitDirectionDescription = "Hacia dónde se mueve la página al salir.",
    ...
    accessYourMusic = "Accede a tu música", permissionDescription = "Lambda Player necesita permiso para leer los archivos de audio almacenados en este dispositivo.", grantAccess = "Conceder acceso", emptyLibraryHint = "Agrega archivos de audio al almacenamiento de tu dispositivo para verlos aquí.", reorder = "Reordenar", menu = "Menú", playbackPosition = "Posición de reproducción",
    appName = "Lambda Player",
    uiEngine = "Motor de interfaz",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "Elige qué lenguaje de diseño usa la aplicación.",
    miuixCustomColors = "Colores personalizados de Miuix",
    miuixCustomColorsDescription = "Genera toda la paleta Miuix a partir del color semilla (motor Monet).",
    paletteStyle = "Estilo de paleta",
    paletteStyleDescription = "Estilo de generación de color para el color semilla.",
    colorSpec = "Especificación de color",
    colorSpecDescription = "Versión de la especificación del esquema de color.",
    colorSpecOnly2021 = "El estilo de paleta actual solo admite Spec 2021",
    appleFloatingBar = "Barra flotante",
    appleFloatingBarDescription = "Usar el dock flotante tipo píldora en lugar de la barra de navegación.",
    m3FloatingBar = "Barra flotante Material 3",
    m3FloatingBarDescription = "Desactivado: barra de navegación clásica de Material 3. Activado: barra flotante de Material 3.",
    dynamicColorDescription = "Usar los colores del fondo de pantalla del sistema (Android 12+).",
    removeWallpaperConfirm = "¿Seguro que quieres quitar el fondo de pantalla?",
    removeCoverConfirm = "¿Seguro que quieres quitar la foto de portada?",
    removePlaylistConfirm = "¿Seguro que quieres eliminar esta lista de reproducción?",
    predictiveBackNone = "Ninguno",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "Escala",
    predictiveBackClassic = "Clásico",
    predictiveBackFollowGesture = "Seguir gesto",
    predictiveBackAlwaysRight = "Siempre a la derecha",
    predictiveBackAlwaysLeft = "Siempre a la izquierda",
    close = "Cerrar",
...
private val RU = EN.copy(
    ...
    themeUiStyleSection = "Стиль интерфейса", themeMiuixUiSection = "Интерфейс Miuix", themeM3UiSection = "Интерфейс Material 3",
    ...
    noSongsToPlay = "Нет треков для воспроизведения",
    ...
    predictiveBackTitle = "Прогнозируемый возврат",
    predictiveBackDescription = "Выберите анимацию жеста назад.",
    predictiveBackExitDirectionTitle = "Направление выхода",
    predictiveBackExitDirectionDescription = "Куда движется закрываемая страница.",
    ...
    accessYourMusic = "Доступ к вашей музыке", permissionDescription = "Lambda Player требуется разрешение на чтение аудиофайлов, сохранённых на этом устройстве.", grantAccess = "Разрешить доступ", emptyLibraryHint = "Добавьте аудиофайлы в память устройства, чтобы они появились здесь.", reorder = "Изменить порядок", menu = "Меню", playbackPosition = "Позиция воспроизведения",
    appName = "Lambda Player",
    uiEngine = "Движок интерфейса",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "Выберите язык дизайна приложения.",
    miuixCustomColors = "Свои цвета Miuix",
    miuixCustomColorsDescription = "Сгенерировать всю палитру Miuix из базового цвета (движок Monet).",
    paletteStyle = "Стиль палитры",
    paletteStyleDescription = "Стиль генерации цвета из базового цвета.",
    colorSpec = "Спецификация цвета",
    colorSpecDescription = "Версия спецификации цветовой схемы.",
    colorSpecOnly2021 = "Текущий стиль палитры поддерживает только Spec 2021",
    appleFloatingBar = "Плавающая панель",
    appleFloatingBarDescription = "Использовать плавающий пилюльный док вместо панели навигации.",
    m3FloatingBar = "Плавающая панель Material 3",
    m3FloatingBarDescription = "Выкл: классическая панель навигации Material 3. Вкл: плавающая панель Material 3.",
    dynamicColorDescription = "Использовать цвета системных обоев (Android 12+).",
    removeWallpaperConfirm = "Удалить обои?",
    removeCoverConfirm = "Удалить фото обложки?",
    removePlaylistConfirm = "Удалить этот плейлист?",
    predictiveBackNone = "Нет",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "Масштаб",
    predictiveBackClassic = "Классика",
    predictiveBackFollowGesture = "По жесту",
    predictiveBackAlwaysRight = "Всегда вправо",
    predictiveBackAlwaysLeft = "Всегда влево",
    close = "Закрыть",
...
private val KA = EN.copy(
    ...
    themeUiStyleSection = "ინტერფეისის სტილი", themeMiuixUiSection = "Miuix ინტერფეისი", themeM3UiSection = "Material 3 ინტერფეისი",
    ...
    noSongsToPlay = "დასაკრავი სიმღერები არ არის",
    ...
    predictiveBackTitle = "პროგნოზირებადი უკან",
    predictiveBackDescription = "აირჩიეთ უკან ჟესტის ანიმაცია.",
    predictiveBackExitDirectionTitle = "გასვლის მიმართულება",
    predictiveBackExitDirectionDescription = "სად მოძრაობს დახურული გვერდი.",
    ...
    accessYourMusic = "შედი შენს მუსიკაში", permissionDescription = "Lambda Player-ს სჭირდება ნებართვა ამ მოწყობილობაზე შენახული აუდიო ფაილების წასაკითხად.", grantAccess = "წვდომის მინიჭება", emptyLibraryHint = "დაამატე აუდიო ფაილები მოწყობილობის მეხსიერებაში, რომ აქ გამოჩნდნენ.", reorder = "გადაალაგე", menu = "მენიუ", playbackPosition = "დაკვრის პოზიცია",
    appName = "Lambda Player",
    uiEngine = "ინტერფეისის ძრავა",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "აირჩიე რომელი დიზაინის ენა გამოიყენოს აპმა.",
    miuixCustomColors = "Miuix საბაჟო ფერები",
    miuixCustomColorsDescription = "მთელი Miuix პალიტრის გენერირება სათესლე ფერიდან (Monet ძრავა).",
    paletteStyle = "პალიტრის სტილი",
    paletteStyleDescription = "ფერების გენერაციის სტილი სათესლე ფერისთვის.",
    colorSpec = "ფერის სპეციფიკაცია",
    colorSpecDescription = "ფერადი სქემის სპეციფიკაციის ვერსია.",
    colorSpecOnly2021 = "მიმდინარე პალიტრის სტილი მხოლოდ Spec 2021-ს უჭერს მხარს",
    appleFloatingBar = "მცურავი ზოლი",
    appleFloatingBarDescription = "ნავიგაციის ზოლის ნაცვლად გამოიყენე მცურავი აბი დოკი.",
    m3FloatingBar = "Material 3 მცურავი ზოლი",
    m3FloatingBarDescription = "გამორთული: კლასიკური Material 3 ნავიგაციის ზოლი. ჩართული: Material 3 მცურავი ზოლი.",
    dynamicColorDescription = "გამოიყენე სისტემის ფონური ფერები (Android 12+).",
    removeWallpaperConfirm = "ნამდვილად გსურს ფონის სურათის წაშლა?",
    removeCoverConfirm = "ნამდვილად გსურს გარეკანის ფოტოს წაშლა?",
    removePlaylistConfirm = "ნამდვილად გსურს ამ დასაკრავი სიის წაშლა?",
    predictiveBackNone = "არცერთი",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "მასშტაბი",
    predictiveBackClassic = "კლასიკური",
    predictiveBackFollowGesture = "ჟესტის მიყოლებით",
    predictiveBackAlwaysRight = "ყოველთვის მარჯვნივ",
    predictiveBackAlwaysLeft = "ყოველთვის მარცხნივ",
    close = "დახურვა",
...
private val AR = EN.copy(
    ...
    themeUiStyleSection = "نمط الواجهة", themeMiuixUiSection = "واجهة Miuix", themeM3UiSection = "واجهة Material 3",
    ...
    noSongsToPlay = "لا توجد أغاني للتشغيل",
    ...
    predictiveBackTitle = "الرجوع التنبؤي",
    predictiveBackDescription = "اختر حركة إيماءة الرجوع.",
    predictiveBackExitDirectionTitle = "اتجاه الخروج",
    predictiveBackExitDirectionDescription = "اتجاه حركة الصفحة عند الخروج.",
    ...
    accessYourMusic = "الوصول إلى موسيقاك", permissionDescription = "يحتاج Lambda Player إلى إذن لقراءة الملفات الصوتية المخزنة على هذا الجهاز.", grantAccess = "منح الوصول", emptyLibraryHint = "أضف ملفات صوتية إلى تخزين جهازك لرؤيتها هنا.", reorder = "إعادة ترتيب", menu = "القائمة", playbackPosition = "موضع التشغيل",
    appName = "Lambda Player",
    uiEngine = "محرك الواجهة",
    miuixUi = "Miuix",
    googleUi = "Material 3",
    uiEngineDescription = "اختر لغة التصميم التي يستخدمها التطبيق.",
    miuixCustomColors = "ألوان مخصصة لـ Miuix",
    miuixCustomColorsDescription = "إنشاء لوحة ألوان Miuix كاملة من اللون الأساسي (محرك Monet).",
    paletteStyle = "نمط اللوحة",
    paletteStyleDescription = "نمط توليد الألوان للون الأساسي.",
    colorSpec = "مواصفة الألوان",
    colorSpecDescription = "إصدار مواصفة مخطط الألوان.",
    colorSpecOnly2021 = "نمط اللوحة الحالي يدعم Spec 2021 فقط",
    appleFloatingBar = "الشريط العائم",
    appleFloatingBarDescription = "استخدم الشريط العائم على شكل كبسولة بدلاً من شريط التنقل.",
    m3FloatingBar = "الشريط العائم Material 3",
    m3FloatingBarDescription = "إيقاف: شريط تنقل Material 3 الكلاسيكي. تشغيل: الشريط العائم Material 3.",
    dynamicColorDescription = "استخدم ألوان خلفية النظام (أندرويد 12 وما فوق).",
    removeWallpaperConfirm = "هل أنت متأكد من إزالة الخلفية؟",
    removeCoverConfirm = "هل أنت متأكد من إزالة صورة الغلاف؟",
    removePlaylistConfirm = "هل أنت متأكد من حذف قائمة التشغيل هذه؟",
    predictiveBackNone = "لا شيء",
    predictiveBackAosp = "AOSP",
    predictiveBackMiuix = "MIUIX",
    predictiveBackScale = "تكبير",
    predictiveBackClassic = "كلاسيكي",
    predictiveBackFollowGesture = "اتباع الإيماءة",
    predictiveBackAlwaysRight = "دائمًا لليمين",
    predictiveBackAlwaysLeft = "دائمًا لليسار",
    close = "إغلاق",
    appearance = "المظهر",
)
