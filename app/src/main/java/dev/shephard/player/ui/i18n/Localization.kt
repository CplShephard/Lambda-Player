...
private val TR = EN.copy(
    ...
    appleFloatingBar = "Apple Yüzen Bar",
    appleFloatingBarDescription = "Miuix navigasyon çubuğu yerine yüzen hap dock kullan.",
...
private val ZH = EN.copy(
    ...
    appleFloatingBar = "Apple 悬浮栏",
    appleFloatingBarDescription = "使用悬浮胶囊式 Dock 而非 Miuix 导航栏。",
...
private val ES = EN.copy(
    ...
    appleFloatingBar = "Barra flotante Apple",
    appleFloatingBarDescription = "Usar el dock flotante tipo píldora en lugar de la barra de navegación de Miuix.",
...
private val RU = EN.copy(
    ...
    appleFloatingBar = "Плавающая панель Apple",
    appleFloatingBarDescription = "Использовать плавающий пилюльный док вместо панели навигации Miuix.",
...
private val KA = EN.copy(
    ...
    appleFloatingBar = "Apple მცურავი ზოლი",
    appleFloatingBarDescription = "Miuix ნავიგაციის ზოლის ნაცვლად გამოიყენე მცურავი აბი დოკი.",
...
private val AR = EN.copy(
    ...
    appleFloatingBar = "الشريط العائم Apple",
    appleFloatingBarDescription = "استخدم الشريط العائم على شكل كبسولة بدلاً من شريط التنقل Miuix.",
