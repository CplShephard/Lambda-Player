...
/**
 * Material 3 expressive "wavy" progress slider — the PixelPlayer signature
 * seek bar. While playing, the active track segment flows like a wave; the
 * thumb turns into a tall line while dragging.
 */
